...
export default async function TrainingArchive() {
  ...
  return <div className="page-shell inner-page"><header className="page-title"><p className="eyebrow">THE ARCHIVE / 訓練檔案庫</p><h1>每一屆，都是<br/><em>下一屆的起點。</em></h1><p>寒訓、暑訓與一路累積下來的方法。依年份翻閱，找到你需要的技術脈絡。</p></header>
